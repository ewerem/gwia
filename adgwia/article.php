...
<body>
          ...
          <div class="row" style="border-bottom: 1px solid #bbb;">
            ...
            <div class="col-sm-12 col-md-12">
              ...
              <h4 style="font-size:25px;">
                <i class="fas fa-file-alt"></i> Article Section
              </h4>
            </div>
          ...
          <div id="article-section">
                ...
                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile"
                  ...
                  View Articles
                    <i style="background: #0d47a1;color: white;padding: 5px;font-size: 14px;border-radius: 20px;">
                      ...
                      $sel3 = $pdo->prepare("SELECT * FROM blog_post");
                      $sel3->execute();
            ...
            <div class="tab-content" id="myTabContent">
              ...
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab" style="padding: 10px;">
                <br>
                <h5 style="font-weight: bold;">ADD ARTICLE</h5>
                <form class="text-center p-2" method="post" enctype="multipart/form-data">
                    ...
                    <!-- Name -->
                    <input type="text" name="title" id="defaultContactFormName" class="form-control mb-4" placeholder="Article Title" required="">

                    <!-- Message -->
                    <div class="form-group">
                        <textarea class="form-control rounded-0" name="para1" id="exampleFormControlTextarea2" rows="3" placeholder="Paragraph 1" required=""></textarea>
                    </div>

                    <!-- Message -->
                    <div class="form-group">
                        <textarea class="form-control rounded-0" name="para2" id="exampleFormControlTextarea2" rows="3" placeholder="Paragraph 2" required=""></textarea>
                    </div>

                    <!-- Message -->
                    <div class="form-group">
                        <textarea class="form-control rounded-0" name="para3" id="exampleFormControlTextarea2" rows="3" placeholder="Paragraph 3"></textarea>
                    </div>

                    <div class="form-group">
                        <textarea class="form-control rounded-0" name="para4" id="exampleFormControlTextarea2" rows="3" placeholder="Paragraph 4"></textarea>
                    </div>

                    <!-- Send button -->
                    <button class="btn btn-primary btn-block" name="sub" type="submit"><i class="fas fa-paper-plane"></i> Submit Post</button>
                ...
                <?php  
                  ...
                  if(isset($_POST['sub'])){
                    ...
                    $location = "article-pix/". $photo_name;
                    ...
                    if($photo_size == 0 || $photo_size >699877){
                      ...
                      blog_post($pdo, $location, $t, $p1, $p2, $p3, $p4);
                  ...
                  ?>
                      ...
                      <!-- Card -->
                        <div class="card">
                          ...
                          <!-- Card image -->
                          <img class="card-img-top" src="<?=$f['photo']?>" alt="<?=$f['title']?>">

                          <!-- Card content -->
                          <div class="card-body">

                            <!-- Title -->
                            <h4 class="card-title" style="text-align: center;"><?=$f['title']?></h4>
                            <!-- Text -->
                            <center>
                              <a href="r-article.php?id=<?=base64_encode($f['id'])?>" class="btn btn-sm btn-primary">
                                Read Article <i class="fas fa-arrow-circle-right"></i>
                              </a>
                              <a href="#" data-toggle="modal" data-target="#centralModalSm" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i> Delete</a>
                            </center>
                          </div>
                      ...
                      <div class="modal-dialog modal-sm" role="document">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-footer justify-content-center">
                            <a href="article.php?id=<?=base64_encode($f['id'])?>" class="btn btn-success">Yes</a>
    ...
    <?php  
      ...
      if(isset($_GET['id'])){
        ...
        $d = $pdo->prepare("DELETE FROM blog_post WHERE id = ?");
        $d->bindParam(1, $id);
        $d->execute();
