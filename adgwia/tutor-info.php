        ...
        <div class="col-sm-12 col-md-9 col-lg-10" style="height: 600px; overflow: auto;">
          ...
          <div class="row" style="border-bottom: 1px solid #bbb;">
            ...
            <div class="col-sm-12 col-md-12">
              ...
              <h4 style="font-size:25px;">
                <i class="fas fa-user-check"></i> Tutor Info
              </h4>

              <a href="tutor.php" class="btn btn-sm btn-dark" style="float: right;margin-top: -40px;">
          ...
          <div id="get-stud">
            ...
            <?php
              ...
              $sel = $pdo->prepare("SELECT * FROM teacher WHERE id = ?");
              $sel->bindParam(1, $id);
              $sel->execute();
                	...
                	<center>
	              	<?php
                        if($f['photo'] == 'no'){
                          ...
                          echo'<img src="../tutor/'.$f['photo'].'" style="width:100px;height:110;border-radius:5px;border:1px solid #eee;">';
                        }
                     ?>
                 	</center>
	             </div>
