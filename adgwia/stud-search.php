      ...
      <p id="plink2">
        ...
        <div class="col-sm-12 col-md-9 col-lg-10" style="height: 600px; overflow: auto;">
              ...
              <center id="search">
                <form method="post">
                  <table border="0" style="width: 100% !important;">
                    <tr>
                      <td width="80px">
                        <button name="search" class="btn btn-sm btn-primary">
                ...
                <?php  
                  ...
                  if(isset($_POST['search'])){
                    ...
                    header('location:stud-search.php?word='.base64_encode($w));
          ...
          <div id="get-stud">
            ...
            <?php
              $w = base64_decode($_GET['word']);

              $sel = $pdo->prepare("SELECT * FROM student WHERE sname LIKE '%$w%' OR oname LIKE '%$w%' OR email LIKE '%$w%' OR phone LIKE '%$w%' OR country LIKE '%$w%' OR course LIKE '%$w%' OR leveledu LIKE '%$w%' OR state LIKE '%$w%' OR gender LIKE '%$w%' ");
              $sel->execute();
                ...
                <table class="table alert-primary" style="width: 100%;">
                  <tr>
                    ...
                    <td style="">
                      ...
                      <strong style="color: purple">MATRIC NO</strong> <i class="far fa-arrow-alt-circle-right"></i> 
                      <?php echo strtoupper($f['adnum']);?>
                      <br>
                      ...
                      <p></p>
                      <a href="stud-info.php?id=<?=base64_encode($f['id'])?>&link=<?=base64_encode('stud-search.php')?>&word=<?=base64_encode($w)?>" style="padding: 3px;border:1px solid #000077;" id="dlink">View More</a>
                    </td>
                  </tr>
                </table>

             <?php
                  }//ending the if that check if user has paid
                }
