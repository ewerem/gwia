...
<body>
          ...
          <div class="row" style="border-bottom: 1px solid #bbb;">
            ...
            <div class="col-sm-12 col-md-12">
              ...
              <h4 style="font-size:25px;">
                <i class="fas fa-flag"></i> Notice Section
              </h4>
            </div>
          ...
          <div id="article-section">
                ...
                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile"
                  ...
                  View Posted Notice
                    <i style="background: #0d47a1;color: white;padding: 5px;font-size: 14px;border-radius: 20px;">
                      ...
                      $sel3 = $pdo->prepare("SELECT * FROM notice");
                      $sel3->execute();
            ...
            <div class="tab-content" id="myTabContent">
              ...
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab" style="padding: 10px;">
                <br>
                <h5 style="font-weight: bold;">ADD NOTICE</h5>
                <form class="text-center p-2" method="post">

                    <!-- Name -->
                    <input type="text" name="title" id="defaultContactFormName" class="form-control mb-4" placeholder="Notice Heading" required="">

                    <!-- Message -->
                    <div class="form-group">
                        <textarea class="form-control rounded-0" name="content" id="exampleFormControlTextarea2" rows="3" placeholder="Notice Content" required=""></textarea>
                    </div>

                    <button class="btn btn-primary btn-block" name="sub" type="submit"><i class="fas fa-paper-plane"></i> Submit Notice</button>
                  ...
                  ?>
                      ...
                      <div class="alert alert-info" style="border:1px solid black;">
                        ...
                        <div id="message" style="font-size: 16px !important;">
                          <p style="font-size:14px;font-family: lucida sans;font-weight: bold;">NOTICE <i class="fas fa-angle-down"></i></p>
                          <?=$f['content']?>
                        </div>
                      ...
                      <div class="modal-dialog modal-sm" role="document">
                        ...
                        <div class="modal-content">
                          <div class="modal-body">
                            <p></p>
                            <center>
                             DO YOU REALLY WANT TO DELETE NOTICE?
                            </center>
                            <p></p>
                          </div>
                          <div class="modal-footer justify-content-center">
                            <a href="notice.php?id=<?=base64_encode($f['id'])?>" class="btn btn-success">Yes</a>
    ...
    <?php  
      ...
      if(isset($_GET['id'])){
        ...
        $d = $pdo->prepare("DELETE FROM notice WHERE id = ?");
        $d->bindParam(1, $id);
        $d->execute();
