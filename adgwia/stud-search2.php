...
<html lang="en-US">
  <head>
    ...
    <title>Non student search</title>
                ...
                <table class="table alert-danger" style="width: 100%;">
                  <tr>
                    ...
                    <td style="">
                      ...
                      <p></p>
                      <a href="stud-info.php?id=<?=base64_encode($f['id'])?>&link=<?=base64_encode('stud-search2.php')?>&word=<?=base64_encode($w)?>" style="padding: 3px;border:1px solid #000077;" id="dlink">View More</a>
                    </td>
                  </tr>
                </table>
