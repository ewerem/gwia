        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarContent">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                <a class="nav-link" href="../adgwia/glogin.php">
          ...
          <div class="row no-gutters">
              ...
              <div class="col-sm-12 col-md-6">
                ...
                <center>
                  ...
                  <h5 style="color: black;font-weight: bold;font-family: lucida sans;">SUPER LOGIN</h5>
                </center>
                ...
                <form method="post" style="border:2px dashed #4285F4; padding: 10px;background: white;">
                  ...
                  <div class="md-form">
                    ...
                    <label for="email"><i class="fas fa-user"></i> Super User</label>
                  </div>

                  <div class="md-form">
                    <input class="form-control" id="email" type="password" name="pass" required="required"/>
                    <label for="email"><i class="fas fa-lock"></i> Super Password</label>
                  </div>
                  <p></p>
                  ...
                  <button class="btn btn-block ml-0" type="submit" name="sub" style="background: #4285F4;color: white;"><i class="fas fa-paper-plane mr-2"></i> 
                    ...
                    <?php
                        ...
                        if(isset($_POST['sub'])){
                          ...
                          $sel = $pdo->prepare("SELECT * FROM admin_super WHERE user = ? AND pass = ?");
                          $sel->bindParam(1, $us);
                          $sel->bindParam(2, $pa);
                          $sel->execute();
